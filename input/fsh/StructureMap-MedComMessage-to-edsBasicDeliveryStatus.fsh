...
Title: "Transformation specification of a MedcomMessagingMessage to an EHMI Delivery Status structure (edsBasicDeliveryStatus)"
Description: "Transformation specification of a MedcomMessagingMessage to an EHMI Delivery Status structure (edsBasicDeliveryStatus)"
Usage: #definition
* id = "StrMap-MedComMessagingMessage2edsBasicDeliveryStatus-transform"
* url = "http://medcomehmi.dk/ig/dk-ehmi-MedcomMessagingMessage/StructureMap/MedcomMessagingMessage2edsBasicDeliveryStatus-transform"
* name = "Transform from a MedcomMessagingMessage to an edsBasicDeliveryStatus"
* title = "Transform from a MedcomMessagingMessage to an edsBasicDeliveryStatus"
* status = #draft
* description = "Transform from a FHIR Messsage to a MedcomMessagingMessage"
...
* group[+].name = "Subtype"
* group[=].typeMode = #none
* group[=].input[0].name = "MedcomMessagingMessage"
* group[=].input[=].type = "MedcomMessagingMessage"
* group[=].input[=].mode = #source
* group[=].input[+].name = "EDSDeliveryStatus"
* group[=].input[=].type = "AuditEvent"
...
* group[=].rule[=].source.context = "MedcomMessagingMessageSenderGLN"
...
* group[=].rule[=].source.context = "MedcomMessagingMessageReceiverGLN"
...
* group[=].rule[=].source.context = "MedcomMessagingMessageMessageType"
