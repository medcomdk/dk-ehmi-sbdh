...
Description: "Transformation specification of a MedcomMessagingMessage to an EHMI Delivery Status structure (edsPatientDeliveryStatus)"
Usage: #definition
* id = "StrMap-MedComMessagingMessage2edsPatientDeliveryStatus-transform"
* url = "http://medcomehmi.dk/ig/dk-ehmi-MedcomMessagingMessage/StructureMap/MedcomMessagingMessage2edsPatientDeliveryStatus-transform"
* name = "Transform from a MedcomMessagingMessage to an edsPatientDeliveryStatus"
* title = "Transform from a MedcomMessagingMessage to an edsPatientDeliveryStatus"
* status = #draft
