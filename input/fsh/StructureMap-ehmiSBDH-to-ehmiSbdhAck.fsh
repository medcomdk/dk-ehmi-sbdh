...
* group[=].rule[=].source.context = "source"
* group[=].rule[=].source.element = "StandardBusinessDocumentHeader/Receiver/identifier"
* group[=].rule[=].target.context = "target"
* group[=].rule[=].target.contextType = #variable
...
* group[=].rule[=].source.context = "source"
* group[=].rule[=].source.element = "StandardBusinessDocumentHeader/Sender/identifier"
* group[=].rule[=].target.context = "target"
* group[=].rule[=].target.contextType = #variable
